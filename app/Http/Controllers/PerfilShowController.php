...
class PerfilShowController extends Controller
{
    ...
    public function update(Request $request, Perfil $perfil)
    {
        ...
        //redireccionar
        return redirect()->action('PerfilShowController@show', ['perfil' => auth()->user()->id ]);
    }
    ...
    public function search(Request $request){
        ...
        $perfiles = User::where('name', 'like', '%' . $busqueda . '%' )->paginate(10);
        $perfiles->appends(['buscar' => $busqueda]);
        return view('busquedas.perfiles.show', compact('perfiles', 'busqueda'));
    }
}
